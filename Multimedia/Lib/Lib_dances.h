...
/*** SCRIPT ***/
constexpr const T_Motion Astronomia_m[] = {
        {(MotionFunc)0, 4800},
...
constexpr const  T_Motion Happybirthday_m[] = {
...
constexpr const  T_Motion Senbonzakura_m[] = {
...
T_Dance Astronomia_dance = {Astronomia_m, 1, sizeof(Astronomia_m)/sizeof(T_Motion), 0, &Astronomia, (task_s**)0, 0};
T_Dance Happybirthday_dance = {Happybirthday_m, 1, sizeof(Happybirthday_m)/sizeof(T_Motion), 0, &Happybirthday, (task_s**)0, 0};
T_Dance Senbonzakura_dance = {Senbonzakura_m, 1, sizeof(Senbonzakura_m)/sizeof(T_Motion), 0, &Senbonzakura, (task_s**)0, 0};
