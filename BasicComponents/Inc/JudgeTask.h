...
typedef struct{
    uint16_t cmdID;
    uint8_t len;
    void (*decodingFunction)(uint8_t * head);
}RefereeDataInfo_t;
...
extern ext_client_custom_graphic_single_t Client_Custom_Graphic_Single;
extern referee_data_t RefereeData;
extern JudgeState_e JUDGE_State;
extern int8_t client_graphic_steps;


extern uint8_t gragh_buffer[30];
extern uint8_t char_buffer[60];

//裁判系统UART中断回调
void JudgeUartRxCpltCallback();
void InitJudgeUart();
//刷新裁判系统上线/掉线的状态
void refreshJudgeState();
